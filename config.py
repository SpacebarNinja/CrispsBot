...
BUTTON_QUESTIONS = [
    "Would you press a button that gives you $10 million but a random stranger loses $1,000?",
    "Would you press a button that makes you the most attractive person alive, but you can never form deep emotional connections?",
    "Would you press a button that lets you know when you'll die, but you can't change it?",
    "Would you press a button that erases one painful memory, but also erases a happy one at random?",
    "Would you press a button that gives you perfect health forever, but you can never eat your favorite food again?",
    "Would you press a button that makes everyone trust you completely, but you can never trust anyone again?",
    "Would you press a button that doubles your lifespan, but everyone you love ages normally?",
    "Would you press a button that lets you read minds, but people can also read yours?",
    "Would you press a button that gives you your dream job, but your best friend loses theirs?",
    "Would you press a button that makes you immune to heartbreak, but also unable to feel deep love?",
    "Would you press a button that lets you redo one day of your life, but you lose a year from the end?",
    "Would you press a button that removes all your insecurities, but also removes your humility?",
    "Would you press a button that gives you $1 million every year, but you can never donate or gift money?",
    "Would you press a button that makes you forget all your exes, but they also forget you?",
    "Would you press a button that lets you speak every language, but you lose your native language?",
    "Would you press a button that makes you famous, but your family becomes strangers?",
    "Would you press a button that cures your worst fear, but gives you a new random phobia?",
    "Would you press a button that makes you always right, but nobody ever believes you?",
    "Would you press a button that lets you see how everyone truly feels about you, but you can't unsee it?",
    "Would you press a button that gives you immortality, but you must watch everyone you love die?",
    "Would you press a button that guarantees success in everything, but removes all sense of achievement?",
    "Would you press a button that lets you relive your happiest moment forever, but never create new ones?",
    "Would you press a button that makes you never feel lonely, but also never feel the joy of reunion?",
    "Would you press a button that removes all physical pain, but also removes the ability to feel pleasure?",
    "Would you press a button that gives you the answer to any question, but you can never ask 'why'?",
    "Would you press a button that makes everyone like you, but no one ever respects you?",
    "Would you press a button that lets you travel anywhere instantly, but you can never return home?",
    "Would you press a button that gives you perfect memory, but you can never forget anything — including trauma?",
    "Would you press a button that makes you the smartest person alive, but you become insufferable to be around?",
    "Would you press a button that lets you know everyone's secrets, but they know yours too?",
    "Would you press a button that removes all conflict from your life, but also removes all passion?",
    "Would you press a button that gives you a perfect body, but your personality becomes bland?",
    "Would you press a button that lets you live your ideal life, but it's entirely a simulation you're unaware of?",
    "Would you press a button that makes you extremely lucky, but all your luck comes from others' misfortune?",
    "Would you press a button that lets you see the future, but you're unable to change it?",
    "Would you press a button that removes all your bad habits, but also removes what made them enjoyable?",
    "Would you press a button that makes you permanently happy, but you lose the ability to feel other emotions?",
    "Would you press a button that gives you your soulmate, but they die exactly 10 years after you meet?",
    "Would you press a button that makes you invulnerable, but you can never feel human touch?",
    "Would you press a button that lets you know your purpose, but you're forced to follow it no matter what?",
    "Would you press a button that gives you the power to save one life, but you must take another?",
    "Would you press a button that removes all inequality in the world, but everyone becomes equally mediocre?",
    "Would you press a button that lets you communicate with the dead, but only for 60 seconds total?",
    "Would you press a button that makes your ex regret leaving you, but you also regret letting them go?",
    "Would you press a button that gives you creative genius, but you become mentally unstable?",
    "Would you press a button that makes all your dreams come true, but you never dream again?",
    "Would you press a button that gives you 10 extra years of life, taken from 10 random strangers?",
    "Would you press a button that lets you feel no jealousy, but also no ambition?",
    "Would you press a button that makes you incredibly charismatic, but everything you say is a lie?",
    "Would you press a button that removes your biggest regret, but creates a new one you can't predict?",
    "Would you press a button that lets you be invisible, but only when you're completely alone?",
    "Would you press a button that gives you unlimited knowledge, but you can never share it?",
    "Would you press a button that makes you forgive everyone who wronged you, but they never apologize?",
    "Would you press a button that lets you experience 100 years of happiness compressed into 1 year, then you die?",
    "Would you press a button that removes all sadness from the world, but also all empathy?",
    "Would you press a button that lets you see alternate universe versions of your life choices?",
    "Would you press a button that gives you the perfect partner, but you'll never be fully satisfied?",
    "Would you press a button that makes you incapable of lying, even when the truth hurts?",
    "Would you press a button that lets you choose how you die, but not when?",
    "Would you press a button that removes all your debt, but someone you care about inherits it?",
    "Would you press a button that makes everyone in the world peaceful, but all individuality disappears?",
    "Would you press a button that lets you experience someone else's life for a day, but they experience yours?",
    "Would you press a button that gives you everything you want, but you'll never want anything again?",
    "Would you press a button that makes you immune to all criticism, but also to all compliments?",
    "Would you press a button that lets you prevent one tragedy, but causes two smaller ones?",
    "Would you press a button that makes your memories 100% accurate, but emotions tied to them fade?",
    "Would you press a button that gives you the ability to never sleep, but you also never dream?",
    "Would you press a button that makes you the most successful person in your field, but you peak at 30?",
    "Would you press a button that lets you save your favorite person's life, but you never see them again?",
    "Would you press a button that removes all negative self-talk, but you also lose self-awareness?",
    "Would you press a button that makes you incredibly brave, but you become reckless?",
    "Would you press a button that lets you find out who your real friends are, but you lose some in the process?",
    "Would you press a button that gives you eternal youth, but you're frozen at your current maturity?",
    "Would you press a button that makes everyone honest with you, but they also become brutally harsh?",
    "Would you press a button that lets you undo one mistake, but you must make a new one of equal weight?",
    "Would you press a button that removes all awkwardness from your life, but also all vulnerability?",
    "Would you press a button that gives you the power to heal anyone, but you absorb their pain?",
    "Would you press a button that lets you know exactly what makes you happy, but you can't pursue it?",
    "Would you press a button that makes you forget your worst trauma, but also who helped you through it?",
    "Would you press a button that gives you a second chance at everything, but no one remembers your first attempts?",
    "Would you press a button that lets you experience true peace, but only in complete isolation?",
    "Would you press a button that makes all your relationships perfect, but none of them are real?",
    "Would you press a button that gives you the wisdom of age, but you lose the energy of youth?",
    "Would you press a button that removes the fear of death, but also the fear of taking risks?",
    "Would you press a button that makes you instantly respected by everyone, but secretly feared?",
    "Would you press a button that lets you rewrite one law of nature, but face unpredictable consequences?",
    "Would you press a button that gives you permanent confidence, but you become unaware of your flaws?",
    "Would you press a button that lets you feel no anxiety, but also no excitement?",
    "Would you press a button that makes you the last person anyone would betray, but also the last they'd confide in?",
    "Would you press a button that gives you the life you always wanted, but you lose the journey to it?",
    "Would you press a button that ends world hunger, but you can never eat a full meal again?",
    "Would you press a button that makes you incredibly funny, but no one ever takes you seriously?",
    "Would you press a button that gives you closure on everything, but you lose the ability to wonder?",
    "Would you press a button that lets you see the good in everyone, but you're blind to danger?",
    "Would you press a button that makes you physically perfect, but mentally stagnant?",
    "Would you press a button that removes all your anxiety, but you become indifferent to outcomes?",
    "Would you press a button that guarantees a happy ending, but a difficult middle?",
    "Would you press a button that lets you be loved by all, but truly known by none?",
    "Would you press a button that makes you immune to manipulation, but also to persuasion?",
    "Would you press a button that gives you your deceased loved one back, but they're not quite the same?",
    "Would you press a button that makes you always content, but never extraordinary?",
    "Would you press a button that lets you live in the past, present, or future — but only one?",
