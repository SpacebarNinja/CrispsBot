...
BUTTON_QUESTIONS = [
    "Would you press a button that gives you $10 million but your closest friend loses everything they have?",
    "Would you press a button that makes you the most attractive person alive, but every relationship you form ends in betrayal?",
    "Would you press a button that lets you know when you'll die, and it's much sooner than you expected?",
    "Would you press a button that erases your worst trauma, but also erases the person who helped you survive it?",
    "Would you press a button that gives you perfect health forever, but everyone you love develops chronic illness?",
    "Would you press a button that makes everyone trust you completely, but you know you don't deserve it?",
    "Would you press a button that doubles your lifespan, but you spend the extra years alone?",
    "Would you press a button that lets you read minds, but you discover everyone secretly resents you?",
    "Would you press a button that gives you your dream career, but your family never forgives you for abandoning them?",
    "Would you press a button that makes you immune to heartbreak, but everyone you date eventually kills themselves?",
    "Would you press a button that lets you redo one day of your life, but you must live with the memory of both versions forever?",
    "Would you press a button that removes all your insecurities, but makes you cruel to those still struggling?",
    "Would you press a button that gives you $1 million every year, but someone in your city starves to fund it?",
    "Would you press a button that makes your ex realize they made a mistake, but they spend their life miserable without you?",
    "Would you press a button that lets you speak every language, but you can never have a deep conversation again?",
    "Would you press a button that makes you famous, but causes your parents to die from the stress of public scrutiny?",
    "Would you press a button that cures your worst fear, but transfers it to your child or future child?",
    "Would you press a button that makes you always right, but you become responsible for acting on that knowledge?",
    "Would you press a button that shows you how everyone truly feels about you, knowing most don't care at all?",
    "Would you press a button that gives you immortality, but you slowly forget everyone you've ever loved?",
    "Would you press a button that guarantees success, but you must sabotage someone else's dream to get it?",
    "Would you press a button that lets you relive your happiest moment, but it becomes less meaningful each time?",
    "Would you press a button that makes you never feel lonely, but you can never be truly intimate with anyone?",
    "Would you press a button that removes all physical pain, but the pain transfers to the person closest to you?",
    "Would you press a button that gives you the answer to any question, but each answer shortens your life by a month?",
    "Would you press a button that makes everyone like you, but it's because they pity you?",
    "Would you press a button that lets you teleport anywhere once, but you can never return to your hometown?",
    "Would you press a button that gives you perfect memory, including the memory of your own inevitable death moment?",
    "Would you press a button that makes you the smartest person alive, but everyone you love becomes resentful of you?",
    "Would you press a button that lets you know everyone's secrets, but you must publicly expose your worst one first?",
    "Would you press a button that removes all conflict from your relationships, but they become hollow?",
    "Would you press a button that gives you a perfect body, but you must give up the hobby you love most?",
    "Would you press a button that lets you live your ideal life in a simulation, knowing your real body rots away?",
    "Would you press a button that makes you extremely lucky, but your luck is stolen directly from your siblings?",
    "Would you press a button that lets you see the future, where everything goes wrong no matter what you do?",
    "Would you press a button that removes all your bad habits, but replaces them with addictions?",
    "Would you press a button that makes you permanently content, but you never accomplish anything meaningful again?",
    "Would you press a button that guarantees you meet your soulmate, but they have a terminal illness?",
    "Would you press a button that makes you invulnerable, but you accidentally hurt everyone who touches you?",
    "Would you press a button that reveals your life's purpose, but it requires sacrificing everything you've built?",
    "Would you press a button that lets you save one life, but you must choose between two people you love equally?",
    "Would you press a button that removes all inequality, but humanity loses all drive and innovation?",
    "Would you press a button that lets you talk to one dead relative, but they're disappointed in who you've become?",
    "Would you press a button that finally makes your ex regret losing you, but you realize you don't care anymore?",
    "Would you press a button that gives you creative genius, but everything you create is forgotten after your death?",
    "Would you press a button that makes all your dreams come true, but your loved ones' dreams become impossible?",
    "Would you press a button that gives you 20 extra years, but they're taken equally from your parents and children?",
    "Would you press a button that eliminates jealousy, but you also stop caring about anything or anyone?",
    "Would you press a button that makes you incredibly charismatic, but every promise you make becomes a lie?",
    "Would you press a button that removes your biggest regret, but the person involved forgets you ever existed?",
    "Would you press a button that lets you be invisible, but you must witness something traumatic every time?",
    "Would you press a button that gives you unlimited knowledge, but it drives you slowly insane?",
    "Would you press a button that makes you forgive everyone, but they use that forgiveness to hurt you again?",
    "Would you press a button that gives you one perfect year, then you die — but it's genuinely perfect?",
    "Would you press a button that removes all sadness from the world, but love becomes meaningless without it?",
    "Would you press a button that shows you the alternate life where you made different choices — and it's better?",
    "Would you press a button that gives you the perfect partner, but you know they only love you because of the button?",
    "Would you press a button that makes you incapable of lying, but people hate you for your honesty?",
    "Would you press a button that lets you choose how you die, but you must choose right now?",
    "Would you press a button that erases all your debt, but it's because someone you love paid it with their life?",
    "Would you press a button that makes everyone peaceful, but they're no longer capable of genuine happiness?",
    "Would you press a button that lets you live someone else's life for a day, but you see they're happier than you?",
    "Would you press a button that gives you everything you want, but you become incapable of wanting anything for others?",
    "Would you press a button that makes you immune to criticism, but you lose the ability to improve?",
    "Would you press a button that prevents one tragedy, but you never know which two smaller ones you caused?",
    "Would you press a button that gives you perfect memories, but you remember every cruel thing you've ever done?",
    "Would you press a button that lets you never sleep, but you must be conscious for every agonizing second of your life?",
    "Would you press a button that makes you the most successful person in your field, but you die at 45?",
    "Would you press a button that saves your favorite person, but they must believe you're dead forever?",
    "Would you press a button that silences your inner critic, but you become oblivious to real warning signs?",
    "Would you press a button that makes you brave, but your courage causes irreparable harm to someone?",
    "Would you press a button that reveals who truly loves you — knowing the list might be empty?",
    "Would you press a button that gives you eternal youth, but you watch everyone you love grow old and die repeatedly?",
    "Would you press a button that makes everyone honest with you, but you can never handle what they say?",
    "Would you press a button that lets you undo one mistake, but someone else makes an equal mistake because of it?",
    "Would you press a button that removes all awkward moments, but genuine connections become impossible?",
    "Would you press a button that lets you heal anyone, but each person you heal takes a year off your life?",
    "Would you press a button that shows you exactly what makes you happy, but you realize you can never have it?",
    "Would you press a button that erases your worst trauma, but you become the kind of person who inflicts trauma?",
    "Would you press a button that gives you infinite second chances, but no one ever trusts your first attempt?",
    "Would you press a button that lets you experience true inner peace, but only by abandoning everyone who needs you?",
    "Would you press a button that makes all your relationships feel perfect, but none of the people are real?",
    "Would you press a button that gives you wisdom, but you become too tired to act on it?",
    "Would you press a button that removes your fear of death, but also your will to live?",
    "Would you press a button that makes everyone respect you, but it's only because they're terrified of you?",
    "Would you press a button that lets you change one universal law, but it unravels reality in ways you can't predict?",
    "Would you press a button that gives you unshakable confidence, but you become incapable of empathy?",
    "Would you press a button that eliminates anxiety, but you also lose the ability to anticipate danger?",
    "Would you press a button that makes you the last person anyone would betray, because you're not worth betraying?",
    "Would you press a button that gives you everything you wanted, but you realize you wanted the wrong things?",
    "Would you press a button that ends world hunger, but you must starve for the rest of your life?",
    "Would you press a button that makes you hilarious, but people laugh at you, not with you?",
    "Would you press a button that gives you closure on everything, but life feels painfully empty afterward?",
    "Would you press a button that lets you see the good in everyone, including those who are genuinely evil?",
    "Would you press a button that makes you physically perfect, but you lose what made you interesting?",
    "Would you press a button that removes all anxiety, but you lose the excitement before good moments too?",
    "Would you press a button that guarantees a happy ending, but only at age 90 — everything before is suffering?",
    "Would you press a button that makes everyone love you, but you know it's artificial and unearned?",
    "Would you press a button that makes you immune to manipulation, but you become unable to be comforted?",
    "Would you press a button that brings back a dead loved one, but they remember dying and blame you for it?",
    "Would you press a button that makes you always content, but contentment feels like giving up?",
    "Would you press a button that lets you live in any era, but you can never interact with your current loved ones again?",
    "Would you press a button that removes all addiction from your life, but also all passion?",
    "Would you press a button that makes you always calm, but you never feel truly alive?",
    "Would you press a button that lets you change one physical feature, but your personality changes too?",
    "Would you press a button that makes every gamble you take pay off, but removes all thrill?",
    "Would you press a button that gives you peace with the past, but amnesia of important lessons?",
    "Would you press a button that lets you skip ahead 5 years, with no memory of what happened?",
    "Would you press a button that makes you fluent in reading people, but they also read you?",
    "Would you press a button that gives you freedom from judgment, but also from feedback?",
    "Would you press a button that makes you never feel anger, but you lose your sense of justice?",
    "Would you press a button that lets you achieve anything you want, but you'll never feel satisfied?",
    "Would you press a button that gives you control over your emotions, but they become performative?",
    "Would you press a button that makes your childhood self proud, but your current self unfulfilled?",
    "Would you press a button that removes all suffering from your life, but also all growth?",
    "Would you press a button that lets you be remembered forever, but only for something you didn't do?",
    "Would you press a button that makes everyone you meet like you instantly, but forget you just as fast?",
    "Would you press a button that gives you the answer to 'what happens after death,' but you can't tell anyone?",
    "Would you press a button that makes your mind quiet forever, but you also lose your inner voice?",
    "Would you press a button that lets you live a lie that makes you happy, or a truth that doesn't?",
    "Would you press a button that removes the possibility of failure, but also the feeling of success?",
    "Would you press a button that makes you the person everyone depends on, but no one supports?",
    "Would you press a button that gives you a perfect reputation, but hollow reality?",
]
