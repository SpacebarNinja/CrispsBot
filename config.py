...
PERSONALITY_QUESTIONS = [
    ...
    "When showering, do you face toward the water or away from it?",
    ...
    "Do you put on both socks then both shoes, or go one foot at a time (sock, shoe, sock, shoe)?",
    ...
    "Do you screenshot things to remember them or trust yourself to remember?",
    "Is it better to have a creative outlet, or spend free time passively consuming content?",
    "When working or studying, do you need music/podcasts in the background or complete silence?",
    ...
    "When you get home, do you change into comfy clothes immediately or stay in your outside clothes?",
    ...
    "Do you set alarms on round numbers (7:00) or random times (7:13)?",
    ...
    "Do you plan your outfit the night before or decide in the morning?",
    ...
    "Do you fold your pizza slice or eat it flat?",
